...
\begin{enumerate}
 ...
 \item Weinschenk, C.G., Overholt, K.J., and Madrzykowski, D., Simulation of the Dynamics of an Attic Fire in a Wood Frame Residential Structure - Chicago, IL, Fire Technology {\em submitted}.
 \item Zhang, C., Silva, J., Weinschenk, C., Kamikawa, D., and Hasemi, Y., Simulation Methodology for Coupled Fire-Structure Analysis: Modeling localized fire tests on a steel column, Fire Technology {\em submitted}.
...
\begin{enumerate}
\item Ontario Professional Fire Fighters Association Health and Safey Conference, February 2015, Broadcast from Washington, DC ({\em invited})
\item IAFF Affiliate Leadership Training Summit, January 2015, Anaheim, CA ({\em invited})
\item Fire and Evacuation Modeling Technical Conference August 2014, Gaithersburg, MD ({\em invited})
\item IAFF Affiliate Leadership Training Summit / N-FORS Stakeholder Meeting, January 2014, Orlando, FL ({\em invited})
\item IAFF Redmond Symposium Occupational Health \& Hazards of the Fire Service, August 2013, Denver, CO ({\em invited})
\item Firehouse Expo, July 2013, Baltimore, MD
\item Metropolitan Fire Chiefs Annual Conference, April 2013, Phoenix, AZ
\item IAFF Affiliate Leadership Training Summit, January 2013, Phoenix, AZ
\item FM Global Open Source CFD Fire Modeling Workshop, May 2012, Boston, MA
\end{enumerate}
...
LabVIEW \\
\LaTeX \\
Google Code / Issue Tracker Support \\
Subversion \\
